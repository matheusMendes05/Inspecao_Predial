...
class estruturas extends Controller
{
    /**
            ...
            try {
                ...
                if (!empty($request->hasFile('fotoFissura'))) {
                    ...
                    if ($request->file('fotoFissura')->isValid()) {
                        ...
                        $estruturas->foto_fissuras = $request->file('fotoFissura')->storeAs('estruturas/fotoFissuras', $nameEstrutura, 's3');
                ...
                if (!empty($request->hasFile('fotoDestacamento'))) {
                    ...
                    if ($request->file('fotoDestacamento')->isValid()) {
                        ...
                        $estruturas->foto_destacamento_DD = $request->file('fotoDestacamento')->storeAs('estruturas/fotoDestacamento', $nameEstrutura, 's3');
                    } else {
                ...
                if (!empty($request->hasFile('fotoArmadura'))) {
                    if ($request->file('fotoArmadura')->isValid()) {
                        ...
                        $estruturas->foto_armadura_exposta = $request->file('fotoArmadura')->storeAs('estruturas/fotoArmadura', $nameEstrutura, 's3');
                    } else {
                ...
                if (!empty($request->hasFile('fotoCorrosao'))) {
                    if ($request->file('fotoCorrosao')->isValid()) {
                        ...
                        $estruturas->foto_corrosao = $request->file('fotoCorrosao')->storeAs('estruturas/fotoCorrosao', $nameEstrutura, 's3');
                    } else {
                ...
                if (!empty($request->hasFile('fotoPeca'))) {
                    if ($request->file('fotoPeca')->isValid()) {
                        ...
                        $estruturas->foto_peca_estrutural_deformacao_excessiva = $request->file('fotoPeca')->storeAs('estruturas/fotoPeca', $nameEstrutura, 's3');
                    } else {
                ...
                if (!empty($request->hasFile('fotoIrregularidades'))) {
                    if ($request->file('fotoIrregularidades')->isValid()) {
                        ...
                        $estruturas->foto_irregularidades_geometricas = $request->file('fotoIrregularidades')->storeAs('estruturas/fotoIrregularidades', $nameEstrutura, 's3');
                    } else {
                ...
                if (!empty($request->hasFile('fotoEflorescencia'))) {
                    if ($request->file('fotoEflorescencia')->isValid()) {
                        ...
                        $estruturas->foto_eflorescencia_lixiviacaoo_infiltracao = $request->file('fotoEflorescencia')->storeAs('estruturas/fotoEflorescencia', $nameEstrutura, 's3');
                    } else {
                ...
                if (!empty($request->hasFile('fotoOutro'))) {
                    if ($request->file('fotoOutro')->isValid()) {
                        ...
                        $estruturas->foto_outros = $request->file('fotoOutro')->storeAs('estruturas/fotoOutro', $nameEstrutura, 's3');
                    } else {
